...
This documentation is for NeuroTessMesh version 0.2.2 software that can be obtained from the homepage.
...
.. code-block:: bash
  ...
  xhost +local:docker
  # Pull the image.
  docker pull vglab/neurotessmesh:0.2.2-nvidia-ubuntu-16.04
  # Download example data
  wget http://neuromorpho.org/dableFiles/allen%20cell%20types/CNG%20version/H16-03-001-01-09-01_559391771_m.CNG.swc
  # Run example
  docker run --gpus 1 -ti --rm -e DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix -v /etc/machine-id:/etc/machine-id -v $(pwd)/H16-03-001-01-09-01_559391771_m.CNG.swc:/H16-03-001-01-09-01_559391771_m.CNG.swc --privileged vglab/neurotessmesh:0.2.2-nvidia-ubuntu-16.04 /usr/bin/NeuroTessMesh -swc /H16-03-001-01-09-01_559391771_m.CNG.swc
